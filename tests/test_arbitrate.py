...
#include "src/engine/include/arbitrate.h"
...
#include "src/engine/kernel/arbitrate.c"
...
def compile_and_run():
    with tempfile.TemporaryDirectory() as td:
        ...
        (pathlib.Path(td)/"spinlock.h").write_text('#include "src/engine/include/libos/spinlock.h"\n')
