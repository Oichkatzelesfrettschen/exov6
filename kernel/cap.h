...
/** Capability identifier type used across the kernel. */
...
#ifdef __cplusplus
static_assert(alignof(struct cap_entry) == 4,
              "struct cap_entry alignment incorrect");
#else
_Static_assert(_Alignof(struct cap_entry) == 4,
               "struct cap_entry alignment incorrect");
#endif
