/**
 * @file fastipc.c
 * @brief Lock-protected fixed-size fast IPC ring buffer and syscall.
 */
...
/** Initialize the fast IPC queue on first use. */
...
/** Enqueue a message if space is available. */
...
/** Syscall: read a message into registers or report empty. */
